...
Popular third-party tools (Git, Terraform, DUB) that never ship their own vocabulary may appear in the separate `uniconfig-profiles` curated pack. That is **not** the normal extension path for your app.
